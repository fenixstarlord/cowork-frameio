...
- `frameio/CLAUDE.md` — Plugin-level agent instructions (you create this in Wave 1, using Appendix A of the spec)
- `frameio/frameio.local.md` — User-specific config template (you create this in Wave 1)
...
Build the full Python MCP server in `frameio/mcp-server/`. Replace all stubs from Wave 1 with production implementations. Reference `docs/frameio-v4-api-reference.md` for all endpoint paths, request/response schemas, auth flow, and upload process.
